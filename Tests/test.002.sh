...
# TEST 2
# Simple entanglement test with 3 users and 2 static entangled CPUs

# set simple entangled CPUs (2, 3)
X=2
Y=3
...
/bin/su -s /bin/bash -c "taskset -c $X ./work 10" testuser2 &

/bin/su -s /bin/bash -c "taskset -c $Y ./work 10" testuser1 &
/bin/su -s /bin/bash -c "taskset -c $Y ./work 10" testuser3 &
